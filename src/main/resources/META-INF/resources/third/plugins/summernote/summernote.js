 ...
 * http://aquilesnote.org/
 *
 * aquilesnote.js
 * Copyright 2013- Alan Hong. and other contributors
 * aquilesnote may be freely distributed under the MIT license./
 *
...
(function (factory) {
  ...
  var Context = function ($note, options) {
    ...
    this._initialize = function () {
      ...
      var modules = $.extend({}, this.options.modules, $.aquilesnote.plugins || {});
    ...
    this.triggerEvent = function () {
      ...
      $note.trigger('aquilesnote.' + namespace, args);
    };
  ...
  $.fn.extend({
    ...
    aquilesnote: function () {
      ...
      options = $.extend({}, $.aquilesnote.options, options);

      // Update options
      options.langInfo = $.extend(true, {}, $.aquilesnote.lang['en-US'], $.aquilesnote.lang[options.lang]);
      options.icons = $.extend(true, {}, $.aquilesnote.options.icons, options.icons);
      options.tooltip = options.tooltip === 'auto' ? !agent.isSupportTouch : options.tooltip;

      this.each(function (idx, note) {
        var $note = $(note);
        if (!$note.data('aquilesnote')) {
          var context = new Context($note, options);
          $note.data('aquilesnote', context);
          $note.data('aquilesnote').triggerEvent('init', context.layoutInfo);
        }
      });

      var $note = this.first();
      if ($note.length) {
        var context = $note.data('aquilesnote');
  ...
  */
  ...
  var Clipboard = function (context) {
    ...
    this.events = {
      'aquilesnote.keydown': function (we, e) {
  ...
  var Handle = function (context) {
    ...
    this.events = {
      'aquilesnote.mousedown': function (we, e) {
        if (self.update(e.target)) {
          e.preventDefault();
        }
      },
      'aquilesnote.keyup aquilesnote.scroll aquilesnote.change aquilesnote.dialog.shown': function () {
        self.update();
      },
      'aquilesnote.disable': function () {
        self.hide();
      },
      'aquilesnote.codeview.toggled': function () {
        self.update();
      }
    };
  ...
  var AutoLink = function (context) {
    ...
    this.events = {
      'aquilesnote.keyup': function (we, e) {
  ...
  var Placeholder = function (context) {
    ...
    this.events = {
      'aquilesnote.init aquilesnote.change': function () {
        self.update();
      },
      'aquilesnote.codeview.toggled': function () {
        self.update();
  ...
  var Toolbar = function (context) {
    ...
    this.initialize = function () {
      ...
      $note.on('aquilesnote.keyup aquilesnote.mouseup aquilesnote.change', function () {
  ...
  var LinkPopover = function (context) {
    ...
    this.events = {
      'aquilesnote.keyup aquilesnote.mouseup aquilesnote.change aquilesnote.scroll': function () {
        self.update();
      },
      'aquilesnote.disable aquilesnote.dialog.shown': function () {
        self.hide();
      }
    };
  ...
  var TablePopover = function (context) {
    ...
    this.events = {
      ...
      'aquilesnote.keyup aquilesnote.scroll aquilesnote.change': function () {
        self.update();
      },
      'aquilesnote.disable': function () {
        self.hide();
  ...
  var HelpDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = [
        '<p class="text-center">',
        '<a href="http://aquilesnote.org/" target="_blank">Aquilesnote 0.8.8</a> · ',
        '<a href="https://github.com/aquilesnote/aquilesnote" target="_blank">Project</a> · ',
        '<a href="https://github.com/aquilesnote/aquilesnote/issues" target="_blank">Issues</a>',
        '</p>'
      ].join('');
  ...
  var AirPopover = function (context) {
    ...
    this.events = {
      'aquilesnote.keyup aquilesnote.mouseup aquilesnote.scroll': function () {
        self.update();
      },
      'aquilesnote.disable aquilesnote.change aquilesnote.dialog.shown': function () {
        self.hide();
      },
      'aquilesnote.focusout': function (we, e) {
  ...
  $.aquilesnote = $.extend($.aquilesnote, {
    version: '0.8.8',
    ui: ui,
    dom: dom,
