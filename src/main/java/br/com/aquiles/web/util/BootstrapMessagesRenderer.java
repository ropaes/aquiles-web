...
public class BootstrapMessagesRenderer extends MessagesRenderer {
    ...
    public void encodeEnd(FacesContext context, UIComponent component) throws IOException {
        ...
        Map<FacesMessage.Severity, List<FacesMessage>> msgs = new HashMap<FacesMessage.Severity, List<FacesMessage>>();
    ...
    private void encodeSeverityMessages(FacesContext facesContext, UIMessages uiMessages,
                                        FacesMessage.Severity severity, List<FacesMessage> messages) throws IOException {
        ...
        writer.writeAttribute("class", "alert " + alertSeverityClass + " fade in", "alert " + alertSeverityClass + " fade in");
